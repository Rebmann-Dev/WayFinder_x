...
API_BASE_SCHEME = os.getenv("API_BASE_SCHEME", "http")


class DockerScraperFlightProvider(FlightProvider):
    """Concrete provider that talks to the existing Go scraper API.

    Logic is moved from services.flight_api.FlightAPIService.
    """
